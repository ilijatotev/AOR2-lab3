...
begin
    ...
    nultaIteracijaAnd : entity work.orKolo(a_orKolo)
        port map (medjuSignal(0), b(0), y(0));
    generisi : for i in 1 to n-1 generate
    begin
        itaIteracijaXor : entity work.xorKolo(a_xorKolo)
            port map (y(i-1), a(i), medju(i));
        itaIteracijaOr : entity work.orKolo(a_orKolo)
            port map (madju(i), b(i), y(i));        
